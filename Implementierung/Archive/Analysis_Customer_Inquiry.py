...
from Benchmarks import Greedy, Interval_Learner, WTP_Learner, One_Time_Relaxed, Dynamic_Relaxed, Amazon_Learner


#Initialization
def Analysis_Customer_Inquiry(n, m, p, a, b_con, eps, bench, max_a):
    ...
    if bench == 1:
        ...
        amazon_learner_res = []        #Array of array with results of Amazon learner benchmark
