...
max_a = 5   #Specifies the maximum amount of tickets one customer can purchase, has to be specified in the initialize function in "Functions" as well
...
n, m, max_a, b, b_con, eps, numb, count, bench, ind_one, ind_dyn = initialize()
